...
if __name__ == "__main__":
    ...
    # models = generator.generate_models([('WineAlcoholContent', 'WineAlcoholContent'), 'WineColor', 'WineLabel', 'WineProducer', 'WineRegion', ('WineCountry', 'WineCountries'), ('WineSugarContent', 'WineSugarContent'), ('WineVariety', 'WineVarieties'), 'WineVolume', 'WineMeal', 'Wine'])

    if args.marker:
        marker = args.marker
    else:
        marker = hashlib.md5("{}{}".format(args.module, args.models)).hexdigest()
