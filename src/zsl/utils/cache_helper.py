...
# NOTE: this is not really a nice solution, but we wanted this `clear_cache` function to be as close to the
#  `cache_output` decorator as possible. Feel free to implement a better solution.
