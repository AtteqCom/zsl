...
class CreateSimpleModelTestCase(TestCase):
    ...
    def testCreateSimpleModelWithParent(self):
        ...
        p = point()
        self.assertIsInstance(p, ParentClass, "Point must be instance of ParentClass.")

    def testCreateSimpleModelWithModule(self):
        module_mock = 0
        point = create_simple_model('Point', ['x', 'y'], parent=ParentClass, model_module=module_mock)
        p = point()
