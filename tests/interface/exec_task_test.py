...
class ExecTaskTestCase(ZslTestCase, TestCase):
    ZSL_TEST_CONFIGURATION = ZslTestConfiguration(app_name='ExecTaskTestCase', container=WebContainer,
    ...
    def testCreateTaskValidCls(self):
        ...
        self.assertIsInstance(task, VersionTask, "A proper task must be returned.")
        self.assertIsInstance(task_callable, Callable, "A proper callable must be returned.")
